...
document.addEventListener("DOMContentLoaded", () => {
  ...
  __webpack_require__(/*! ./modules/video */ "./js/modules/video.js");

  __webpack_require__(/*! ./modules/timeline */ "./js/modules/timeline.js");

  __webpack_require__(/*! ./modules/tab-section */ "./js/modules/tab-section.js");
  ...
  var menu = [...menuItems]; // init Swiper:

  const mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper-container-h", {
    direction: "horizontal",
    loop: false,
    spaceBetween: 100,
    // effect: "fade",
  ...
  var galleryTop = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".gallery-top", {
    ...
    on: {
      slideChange: function () {
        const slideIframe = document.querySelectorAll('iframe[src*="youtube.com"]');
  ...
  var mapSliderLeft = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".map__slider-left", {
    spaceBetween: 50,
    slidesPerView: 1,
    freeMode: false,
    watchSlidesVisibility: false,
  ...
  var mapSliderRight = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".map__slider-right", {
    spaceBetween: 30,
    slidesPerView: 1,
    nasted: true
  });
  mapSliderLeft.controller.control = mapSliderRight;
  var catalogSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".collections__catalog-slider", {
    spaceBetween: 20,
    nasted: true,
    slidesPerView: 1,
    // centeredSlides: true,
  ...
  var tabsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".tab-section__thumbs-slider", {
    spaceBetween: 20,
    nasted: true,
    slidesPerView: 2,
    // centeredSlides: true,
  ...
  var timelineYearsSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".timeline__years-slider", {
    spaceBetween: 20,
    nasted: true,
    slidesPerView: "auto",
    // centeredSlides: true,
  ...
  var description = $(".timeline__pin-description"); // var mp = null;
  // function init(evt) {
  ...
  modals.forEach(function (trigger) {
    trigger.addEventListener("click", function (event) {
      event.preventDefault(); // const modal = document.getElementById(trigger.dataset.modal);
      ...
      const slider_img = document.querySelector(".modal img"); // var images = document.querySelectorAll(".item__article-thumb a");
...
const modalContent = document.querySelectorAll(".timeline__content-item"); // if (modalTriggers) {
//   setTimeout(() => {
//     // if (modalContent) {
...
modalTriggers.forEach(trigger => {
  trigger.addEventListener("click", () => {
    ...
    const popupModalOpen = document.querySelector(".timeline__content-item--active");
